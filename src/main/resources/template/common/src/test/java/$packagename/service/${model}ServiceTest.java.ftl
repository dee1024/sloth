...
public class ${upperFirstLetterName}ServiceTest {
	...
	public void testGetBy${upperFirstLetterPrimaryKey}(){
		...
		${upperFirstLetterName} temp = ${lowerFirstLetterName}Service.getBy${upperFirstLetterPrimaryKey}(${lowerFirstLetterPrimaryKey});
		Assert.assertEquals(expId,temp.get${upperFirstLetterPrimaryKey}()+"");
	}
